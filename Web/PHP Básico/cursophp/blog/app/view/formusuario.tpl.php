<div class="container marginTop">
	...
	<form method="POST" action="index.php?m=admin&c=usuarios&a=<?=$tpl["dados"]["action"]?>">
		<div class="row">
			...
			<div class="col-xs-10">
					<input type="text" name="usuario" class="col-xs-12 form-control" value="<?=$tpl["dados"]["usuariouser"]?>" <?=$tpl["dados"]["auxusuario"]?> autofocus required />
			</div>
		</div>
		<div class="row marginTop">
			...
			<div class="col-xs-10">
					<input type="text" name="nome" class="col-xs-12 form-control" value="<?=$tpl["dados"]["usuarionome"]?>" autofocus required/>
			</div>
		</div>
